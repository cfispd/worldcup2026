...
function setLang(lang) {
  ...
  // Champion banner bilingual text
  const finalBannerText = document.getElementById('finalBannerText');
  if (finalBannerText) {
    finalBannerText.innerHTML = lang === 'zh'
      ? '<strong>西班牙</strong>夺得2026年世界杯冠军！&nbsp;·&nbsp; 决赛：西班牙 1–0 阿根廷（加时）'
      : '<strong>España</strong> are the 2026 FIFA World Cup Champions! &nbsp;·&nbsp; Final: Spain 1–0 Argentina (AET)';
  }
